...
$string['meetingsdkid'] = 'Meeting SDK Key';
$string['meetingsdkid_desc'] = '';
$string['meetingsdksecret'] = 'Meeting SDK Secret';
$string['meetingsdksecret_desc'] = '';
...
$string['registrants_email_notification'] = 'Registrants email notifications';
$string['registrants_email_notification_help'] = 'Whether to send registrants email notifications about their registration approval, cancellation, or rejection.<br/>Set this value to true to also use the registrants_confirmation_email parameter.';
$string['registrants_confirmation_email'] = 'Registrants email confirmation';
$string['registrants_confirmation_email_help'] = 'Whether to send registrants an email confirmation.';
$string['allow_multiple_devices'] = 'Allow multiple devices';
$string['allow_multiple_devices_help'] = 'Whether to allow attendees to join a meeting from multiple devices. This setting is only applied to meetings with registration enabled.';
$string['autoregister_user'] = 'Automatic user registration';
$string['autoregister_user_help'] = 'Whether to autoregister moodle users to zoom meeting/webinar.';
...
$string['zoom:viewownreport'] = 'View Zoom own meetings report';
$string['viewownreportlink'] = 'Meetings report';
...
$string['ownreportdatawarning'] = 'Video lessons presence and absence data are update every other 24 hours.';
$string['ownreportdatawarning_sefa'] = 'Video lessons presence data are update every other 24 hours.';
